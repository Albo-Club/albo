...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const routeLabels: Record<string, string> = {
    "/dashboard": t('breadcrumbs.dealflow'),
    "/opportunities": t('breadcrumbs.dealflow'),
    "/inbox": t('breadcrumbs.inbox'),
    "/portfolio": t('breadcrumbs.portfolio'),
    "/submit": t('breadcrumbs.submitDeal'),
    "/profile": t('breadcrumbs.profile'),
    "/admin": t('breadcrumbs.admin'),
    "/workspace-settings": t('breadcrumbs.workspaceSettings'),
    "/workspace": t('breadcrumbs.workspaceSettings'),
  };

  const currentPath = location.pathname;
  const pageLabel = routeLabels[currentPath] || t('breadcrumbs.page');
            ...
            <BreadcrumbList>
              {isDetailPage && parentLabel ? (
                <>
                  ...
                  <BreadcrumbItem>
                    <BreadcrumbPage>{t('breadcrumbs.detail')}</BreadcrumbPage>
                  </BreadcrumbItem>
                </>
              ) : (
                <BreadcrumbItem>
