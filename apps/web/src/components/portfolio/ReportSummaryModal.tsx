        ...
        <DialogHeader className="p-6 pb-4 border-b">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <DialogTitle className="text-lg font-semibold">
                  {t('companyDetail.reports.summary')} {reportPeriod ? `- ${reportPeriod}` : ""}
                </DialogTitle>
                {companyName && (
            ...
            <div className="flex items-center gap-2">
              ...
              <Button variant="ghost" size="icon" className="h-8 w-8" onClick={handleCopy} title={t('common.copyLink')}>
                {copied ? (
              ...
              <Button variant="ghost" size="icon" className="h-8 w-8" onClick={handleDownload} title={t('common.download')}>
        ...
        <div className="flex-1 min-h-0 overflow-hidden">
          {summary ? (
            isHtml ? (
              <MemoHtmlFrame
                html={summary}
                title={`${t('companyDetail.reports.summary')} - ${reportPeriod || "Report"}`}
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-sm text-muted-foreground italic">
                {t('companyDetail.reports.noSummary')}
              </p>
            </div>
          )}
        </div>
