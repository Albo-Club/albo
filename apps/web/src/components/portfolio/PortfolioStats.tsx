...
export function PortfolioStats({ companies }: PortfolioStatsProps) {
  ...
  const stats = [
    {
      label: t('portfolio.stats.totalInvested'),
      value: formatCurrency(totalInvested),
      icon: Wallet,
      description: t('portfolio.stats.totalInvestedDesc'),
    },
    {
      label: t('portfolio.stats.companies'),
      value: companies.length.toString(),
      icon: Building2,
      description: t('portfolio.stats.companiesDesc'),
    },
    {
      label: t('portfolio.stats.sectors'),
      value: uniqueSectors.size.toString(),
      icon: PieChart,
      description: t('portfolio.stats.sectorsDesc'),
    },
    {
      label: t('portfolio.stats.avgParticipation'),
      value: averageOwnership ? `${(averageOwnership * 100).toFixed(2)}%` : "-",
      icon: TrendingUp,
      description: t('portfolio.stats.avgParticipationDesc'),
    },
  ];
