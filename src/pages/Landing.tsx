  ...
  return (
    <div className="absolute inset-0 -z-10 h-full w-full bg-background">
      <div 
        ...
        style={{
          backgroundImage: `radial-gradient(circle at 25px 25px, hsl(var(--primary) / 0.15) 2px, transparent 0)`,
    ...
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto flex min-h-[calc(100vh-80px)] flex-col items-center justify-center px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mb-6 bg-gradient-to-br from-foreground to-foreground/70 bg-clip-text text-5xl font-bold tracking-tight text-transparent sm:text-6xl lg:text-7xl animate-slide-up">
            Analyse your pitch deck!
          </h1>

          <p className="mb-10 text-lg text-muted-foreground sm:text-xl lg:text-2xl animate-slide-up" style={{ animationDelay: '0.1s' }}>
            Get instant, actionable insights of the market and company directly from the pitch deck
          </p>
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-3">
            <div className="rounded-lg border border-border bg-card/50 p-6 backdrop-blur-sm hover:shadow-elegant transition-all duration-300 animate-slide-up" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="rounded-lg border border-border bg-card/50 p-6 backdrop-blur-sm hover:shadow-elegant transition-all duration-300 animate-slide-up" style={{ animationDelay: '0.4s' }}>
              <div className="mb-3 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10">
            ...
            <div className="rounded-lg border border-border bg-card/50 p-6 backdrop-blur-sm hover:shadow-elegant transition-all duration-300 animate-slide-up" style={{ animationDelay: '0.5s' }}>
              <div className="mb-3 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10">
