...
export const ONBOARDING_STEPS: Record<OnboardingStatus, OnboardingStep> = {
  ...
  [OnboardingStatus.WORKSPACE_PENDING]: {
    ...
    description: 'Créez un workspace ou rejoignez une équipe existante.',
  ...
  [OnboardingStatus.INVITE_TEAM]: {
    ...
    description: 'Collaborez avec vos collègues sur vos deals.',
    path: '/onboarding/invite-team',
    stepNumber: 3,
    skippable: true, // On peut sauter cette étape
    icon: 'Users',
  },
  [OnboardingStatus.COMPLETED]: {
    id: OnboardingStatus.COMPLETED,
    title: 'Bienvenue sur Albo !',
    description: 'Vous êtes prêt à gérer vos deals.',
    path: '/dashboard',
    stepNumber: 4,
    skippable: false,
    icon: 'CheckCircle',
